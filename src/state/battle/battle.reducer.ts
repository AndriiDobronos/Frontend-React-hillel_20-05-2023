...
export const battleReducer = (state:IBattleStore = initialState, action: AnyAction,userName1:string = state.userName1,
                              userName2:string = state.userName2):IBattleStore => {
    switch (action.type) {
